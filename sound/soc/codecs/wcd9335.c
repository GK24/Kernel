...
#ifdef CONFIG_SOUND_CONTROL
static struct snd_soc_codec *sound_control_codec;

static ssize_t headphone_gain_show(struct kobject *kobj,
		struct kobj_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%d %d\n",
		snd_soc_read(sound_control_codec, WCD9335_CDC_RX1_RX_VOL_CTL),
		snd_soc_read(sound_control_codec, WCD9335_CDC_RX2_RX_VOL_CTL)
	);
}
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	snd_soc_write(sound_control_codec, WCD9335_CDC_RX1_RX_VOL_MIX_CTL, input_l);
	snd_soc_write(sound_control_codec, WCD9335_CDC_RX2_RX_VOL_MIX_CTL, input_r);
	snd_soc_write(sound_control_codec, WCD9335_CDC_RX1_RX_VOL_CTL, input_l);
	snd_soc_write(sound_control_codec, WCD9335_CDC_RX2_RX_VOL_CTL, input_r);
...
static ssize_t headphone_pa_gain_show(struct kobject *kobj,
		struct kobj_attribute *attr, char *buf)
{
	u8 hph_l_gain = snd_soc_read(sound_control_codec, WCD9335_HPH_L_EN);
	u8 hph_r_gain = snd_soc_read(sound_control_codec, WCD9335_HPH_R_EN);
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	struct tasha_priv *tasha = snd_soc_codec_get_drvdata(sound_control_codec);
	...
	snd_soc_update_bits(sound_control_codec, WCD9335_HPH_L_EN, 0x1f, input_l);
	snd_soc_update_bits(sound_control_codec, WCD9335_HPH_R_EN, 0x1f, input_r);
		...
		struct kobj_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%d\n",
		snd_soc_read(sound_control_codec, WCD9335_CDC_RX0_RX_VOL_CTL));
}
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	snd_soc_write(sound_control_codec, WCD9335_CDC_RX0_RX_VOL_CTL, input);
